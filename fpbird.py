...
if __name__ == "__main__":
    ...
    GAME_SPRITES['message'] =pygame.image.load('images/layout.png').convert_alpha()
    GAME_SPRITES['base'] =pygame.image.load('images/ground.png').convert_alpha()
